...
# Generated by qmake (2.01a) (Qt 4.5.0) on: mer. mai 20 17:49:04 2009
# Project:  nutsh-05.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.5/mkspecs/macx-g++ -macx CONFIG+=debug_and_release CONFIG+=release -o Makefile nutsh-05.pro
#############################################################################
...
Makefile: nutsh-05.pro  /usr/local/Qt4.5/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.5/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.5/mkspecs/macx-g++ -macx CONFIG+=debug_and_release CONFIG+=release -o Makefile nutsh-05.pro
